...
<head>
    ...
    <link rel="icon" href="{{ Vite::asset('/resources/images/weblogo.png')}}"/>
    <title>Admin Login - SalVents</title>
...
<body class="custom-bg">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div class="flex items-center justify-center mb-6">
            ...
            <h1 class="text-4xl font-bold">Admin - SalVents</h1>
        </div>

        <!-- Login Form -->
        <form action="/admin-logging" method="POST" class="space-y-4">
            @csrf
            <!-- Email -->
            <div>
            ...
            <div class="flex justify-between mt-4 space-x-4">
                <button type="button" class="flex-1 bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300"><a href="/home">Cancel</a></button>
